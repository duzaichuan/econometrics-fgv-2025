...
- Regressions with non-stationary data only make sense in a specific context (Cointegration -- more on that later);
...
- Putting it together:
$$
\frac{1}{\sigma^2 T}\sum_{t=1}^{T}y_{t-1}u_t \xrightarrow{d} \frac{1}{2}(\chi^2 - 1);
$$
...
- See the Chapter 16 on Hansens book about unit roots;
